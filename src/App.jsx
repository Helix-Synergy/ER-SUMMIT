  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path=  "/er-summit-orators"element={<Orators />} />
        <Route path="/about-er-summit" element={<AboutOralMed />} />
        <Route path="/er-summit-event-schedule"element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/er-summit-conference-tracks/" element={<RotatingLogos />} />
