...
colors: {
  ...
  /* 🎨 Supporting / UI (derived from brand color) */
  sky: "rgba(59, 143, 166, 0.1)",      // light background tint
  orange: "rgba(59, 143, 166, 0.4)",   // hover / highlight
  lightGreen: "rgba(59, 143, 166, 0.2)",
